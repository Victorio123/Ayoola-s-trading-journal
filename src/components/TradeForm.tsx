  ...
  return (
    <div id="trade-input-form-container" className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-4" id="log-trade-form">
          ...
          <div className="grid grid-cols-1 gap-2">
            ...
            {selectedEmotion === 'custom' && (
              <input
                type="text"
                maxLength={40}
                className="w-full bg-zinc-950 border border-zinc-800 focus:border-zinc-700 focus:outline-none rounded-lg px-3 py-2 text-sm text-white placeholder:text-zinc-600 mt-1"
                placeholder="How did you feel? (e.g. impatient, restless)"
                value={customEmotion}
        ...
        {/* Date Selector & Description Notes */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div>
            ...
            <input
              type="text"
              className="w-full bg-zinc-950 border border-zinc-800 focus:border-zinc-700 focus:outline-none rounded-lg px-3 py-2 text-sm text-white placeholder:text-zinc-600 truncate"
              placeholder="Break of structure key support..."
              value={notes}
